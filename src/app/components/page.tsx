...
const ComponentsPage = () => {
  ...
  return (
    <section className="grid-layout gap-6">
      <div className="bg-muted text-muted-foreground p-4 rounded-xl gap-2 flex flex-col">
        <h1>Control panel</h1>
        <section className="border-2 p-2 rounded-lg flex flex-col gap-4">
      ...
      <div>
        {[
          ...
          return (
            <div className="flex gap-8 my-2 border-b justify-center" key={c}>
